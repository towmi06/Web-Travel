function loadManageTourInformation() {
    ...
    xhr.open('GET', 'support-management/manage-tour-information.jsp', true);
...
function sortTable3() {
    ...
    const columnIndex = document.getElementById("sort-options3").value;
    ...
    document.querySelectorAll('#tourTable th').forEach(headerCell => {
...
document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("searchInput4").addEventListener("keyup", searchTable4);
});